...
<head>
	...
	<title>Forgot Password - Game Day Valet</title>
...
<body>
	...
	<main class="page">
		<section class="hero">
			...
			<p>Enter your account email and we'll email you a one-time code to reset your password.</p>
		...
		<section>
			<div class="card">
				...
				<p class="sub">We’ll email you a reset code</p>
				...
				<form method="POST" action="{{ route('rentalsystem.forgot-password.submit') }}">
					@csrf
					<label class="label" for="email">EMAIL</label>
					<input class="input @error('email') is-invalid @enderror" type="email" id="email" name="email" value="{{ old('email') }}" required>
