...
<head>
    ...
    <title>Privacy Policy - Game Day Valet</title>
...
<body>
    <header class="header">
        <div class="header-content">
            <div class="logo"><i class="fas fa-shield-alt"></i> Game Day Valet</div>
            <div>
    ...
    <main class="main">
        <section class="hero" id="hero">
            ...
            <p class="subtitle">Read how we collect, use and protect your data.</p>
        </section>
        <section class="card">
            <div id="policy" class="content">
                @php $has = false; @endphp
                @if(isset($policies) && count($policies) > 0)
                    @foreach($policies as $it)
                        @php
