...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3" action="{{ route('tournament-management.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="3" placeholder="Enter tournament description">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="tax_rate" class="form-control @error('tax_rate') is-invalid @enderror" id="tax_rate" value="{{ old('tax_rate') }}" placeholder="e.g. 7.5" required>
                        @error('tax_rate')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
