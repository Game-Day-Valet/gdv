        ...
        <div class="email-content">
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $rental->phone_number ?? 'N/A' }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Email:</span>
                    <span class="detail-value">{{ $rental->email ?? 'N/A' }}</span>
                </div>
            ...
            <div class="items-section">
                ...
                <div class="item-row">
                    ...
                    <span style="margin-left: 350px;">  Qty: {{ $item['quantity'] }}</span>
                </div>
                @endif
                @endforeach
            </div>
                ...
                @foreach($rental->bundles as $bundle)
                    @if(is_array($bundle) && isset($bundle['bundle_id']))
                        <div class="item-row">
                            ...
                            <span style="margin-left: 350px;">  Qty: {{ $bundle['quantity'] ?? 1 }}</span>
                        </div>
                    @elseif(is_numeric($bundle))
                        <div class="item-row">
                            <span>{{ $bundleNames[$bundle] ?? 'Bundle' }}</span>
                            <span style="margin-left: 350px;">  Qty: 1</span>
                        </div>
                    @endif
                @endforeach
            </div>
