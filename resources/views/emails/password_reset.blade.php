...
<head>
    ...
    <title>Password Reset - Game Day Valet</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p class="verification-text">
                We received a request to reset your password for <span class="app-name">Game Day Valet</span>.
                Please use the 6-character code below to reset your password:
            </p>
            ...
            <div class="security-note">
                <p><strong>Security Note:</strong> This code will expire in 60 minutes. If you did not request a password reset, you can safely ignore this email.</p>
            </div>
