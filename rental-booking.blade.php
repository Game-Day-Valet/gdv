...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .addon-name { font-weight: 600; color: var(--gdv-white); font-size: 15px; }
        .addon-name small { display: block; color: var(--gdv-muted); font-weight: 400; font-size: 12px; }
        .addon-price { font-weight: 800; color: var(--gdv-gold); font-size: 15px; }
        .qty-ctrl {
            display: flex;
            align-items: center;
            background: var(--gdv-black);
    ...
    <script>
        (function () {
            ...
            function recalc() {
                ...
                if (payBtnText) {
                    payBtnText.textContent = selectedBundle ? ('Pay ' + fmt(total) + ' Now') : 'Pay Now';
                }
            ...
            // ===== Apple Pay submits the form (Stripe Checkout handles Apple Pay on next page) =====
            const applePayBtn = document.getElementById('applePayBtn');
            if (applePayBtn) {
            ...
            document.getElementById('bookingForm').addEventListener('submit', function (e) {
                if (!selectedBundle) {
                    ...
                    alert('Please choose a setup before checking out.');
                }
            });
